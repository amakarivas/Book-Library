...
document.getElementById("addBooks").addEventListener("click",toggleNavBar);
document.getElementById("viewBooks").addEventListener("click",toggleNavBar);

let contractInstance=null;
let client=null;
let contractAddress="ct_2LPFFmXuDTAzXd6W6HVNARirj6n9YEzq8XQSrCPCyQLULfBCWx";
let contractSource=`
...
addBookToDom("Amaka","456789234567");
